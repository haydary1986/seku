...
const toolsNav = computed(() => [
  ...(isAdmin.value ? [{ name: 'Nuclei Scan', path: '/tools/nuclei', icon: 'M13 10V3L4 14h7v7l9-11h-7z' }] : []),
  ...(isAdmin.value ? [{ name: 'الوكلاء', path: '/agents', icon: 'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01' }] : []),
  { name: 'الروابط المشتركة', path: '/correlations', icon: 'M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z' },
  { name: 'Agent Downloads', path: '/downloads', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4' },
...
const accountNav = computed(() => {
  ...
  if (isAdmin.value) {
    items.push(
      ...
      { name: 'SEO', path: '/seo', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v6m-3-3h6' },
