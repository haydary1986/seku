...
<template>
  <div class="public-shell">
    <!-- Header Banner -->
    <div class="text-white ring-grid">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="text-center">
          ...
          <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
            Seku <span class="text-gradient">Scoring Methodology</span>
          </h1>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div v-if="loading" class="flex flex-col items-center justify-center py-24">
        ...
        <p class="mt-4 text-slate-500 dark:text-slate-400 text-sm">Loading methodology...</p>
      </div>
      ...
      <div v-else-if="methodology">
        ...
        <div class="card p-6 sm:p-8 mb-8">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-2">How the Score is Calculated</h2>
              ...
              <div class="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-4">
                <p class="text-sm font-medium text-slate-700 dark:text-slate-200 mb-3">Category Weight Distribution (Total: {{ totalWeight }}%)</p>
                <div class="space-y-2">
                  <div v-for="cat in methodology.categories" :key="cat.id" class="flex items-center gap-3">
                    <span class="text-xs font-medium text-slate-700 dark:text-slate-300 w-44 truncate">{{ cat.name }}</span>
                    ...
                    <span class="text-xs font-bold text-slate-700 dark:text-slate-200 w-12 text-right">{{ cat.weight }}%</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div class="flex items-center gap-4 mb-3">
                ...
                <div>
                  <p class="font-bold text-slate-900 dark:text-white text-lg">{{ grade.label }}</p>
                  <p class="text-sm text-slate-500 dark:text-slate-400">{{ grade.min_score }} - {{ grade.max_score }} pts</p>
                </div>
              </div>
        ...
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Security Categories</h2>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <button
              ...
              class="w-full flex items-center gap-4 p-5 sm:p-6 text-left hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
            >
              <!-- Icon -->
              <div class="flex-shrink-0 w-12 h-12 bg-emerald-500/15 rounded-xl flex items-center justify-center">
                <svg class="w-6 h-6 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex-shrink-0 hidden md:flex items-center gap-1 bg-slate-100 dark:bg-white/5 rounded-lg px-3 py-1.5">
                ...
                <span class="text-xs text-slate-500 dark:text-slate-400">checks</span>
              </div>
            ...
            <div v-if="isCategoryExpanded(cat.id)" class="border-t border-gray-100 dark:border-white/10">
              ...
              <div class="px-5 sm:px-6 pt-5 pb-2">
                ...
                <div class="sm:hidden mt-2">
                  <span class="text-sm font-bold text-emerald-600 dark:text-emerald-400">Weight: {{ cat.weight }}%</span>
                </div>
              </div>
              ...
              <div class="px-5 sm:px-6 pb-6 space-y-4 mt-2">
                ...
                >
                  ...
                  <div class="bg-slate-50 dark:bg-white/5 px-5 py-4">
                    <div class="flex items-start justify-between gap-4">
                      ...
                      <div class="flex-shrink-0 text-right">
                        <div class="text-sm font-semibold text-slate-700 dark:text-slate-200">Max: {{ check.max_score }}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- Scoring Breakdown -->
                  <div class="px-5 py-4">
                    <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Scoring Breakdown</p>
                    <div class="space-y-2">
                      <div
        ...
        <!-- Footer Note -->
        <div class="mt-12 card p-6 sm:p-8 text-center">
          ...
          <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2">About This Methodology</h3>
