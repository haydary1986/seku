...
useSEO({
  ...
  description: 'سيكو منصة فحص أمان المواقع الإلكترونية الأقوى في العراق. 37 فئة فحص أمني، تقييم من 1000 نقطة، تحليل بالذكاء الاصطناعي. ابدأ مجاناً.',
...
const features = computed(() => [
  ...
  { title: t('أمان الكوكيز', 'Cookie Security'), desc: t('فحص أعلام Secure, HttpOnly, SameSite لحماية جلسات المستخدمين', 'Secure, HttpOnly, SameSite flags for session protection'), weight: 10, icon: 'M21 12a9 9 0 11-18 0 9 9 0 0118 0z', bg: 'bg-emerald-100', icon_color: 'text-emerald-600' },
  ...
  { title: t('مخاطر السكربتات الخارجية', 'Third-Party Script Risk'), desc: t('عدد السكربتات الخارجية، سلامة الموارد SRI، مصادر موثوقة، CSS خارجي', 'External script count, SRI integrity, trusted sources, external CSS'), weight: 6, icon: 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1', bg: 'bg-cyan-100', icon_color: 'text-cyan-600' },
...
<template>
  <div class="public-shell min-h-screen" :dir="isRTL ? 'rtl' : 'ltr'">
    ...
    <!-- Navbar is provided globally by the shared PublicHeader (unified across all public pages) -->
