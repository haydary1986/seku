...
const webhookTypes = [
  ...
  { value: 'teams', label: 'Microsoft Teams', icon: 'teams', placeholder: 'https://outlook.office.com/webhook/...' },
        ...
        <div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            >
              ...
              <svg v-else-if="wt.value === 'teams'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4zm7-4a3 3 0 11-3-3"/>
              </svg>
              <!-- Custom icon -->
          ...
          <tr v-for="wh in webhooks" :key="wh.ID" class="border-t border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-800">
            ...
            <td class="py-3 px-4">
              ...
              >
                ...
                <!-- Microsoft Teams mini icon -->
                <svg v-else-if="wh.type === 'teams'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4zm7-4a3 3 0 11-3-3"/>
                </svg>
                <!-- Custom mini icon -->
